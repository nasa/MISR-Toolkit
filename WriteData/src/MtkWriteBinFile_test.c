...
int main() {
  ...
  MTK_PRINT_STATUS(cn,"Testing MtkWriteBinFile");
  ...
  status = MtkWriteBinFile(outfilename, dbuf, mapinfo);
  ...
  status = MtkWriteBinFile(NULL, dbuf, mapinfo);
