/*****************************************************************************
  ...
  26 October 1996, Alward N. Siyyid 	Changed the value for MAX_RIGHT_MARGIN from
					132 to 317 to allow for long words in a string
...
int ODLFormatString (char stmt[], VALUE_DATA *item, int *column, 
                     int left_margin, int right_margin, int format_flag, 
                     int is_pointer)
...
int ODLFormatComment (char *stmt, char *comment, int left_margin, 
                      int right_margin)
{
  char    c;                    /* Current input character                  */
  int     i;                    /* Loop index                               */
